          ...
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View>
              <Input
                ...
                onChangeText={(value) =>
                  this.handleInputChange('studentId', value)
                }
              />
              <Input
                value={this.state.nameSurname}
                onChangeText={(value) =>
                  this.handleInputChange('nameSurname', value)
                }
              />
              <Input
                keyboartType="numeric"
              ...
              <Input
                ...
                onChangeText={(value) =>
                  this.handleInputChange('faculty', value)
                }
              />
              <Input
                value={this.state.department}
                onChangeText={(value) =>
                  this.handleInputChange('department', value)
                }
              />
            </View>
          </TouchableWithoutFeedback>
...
function mapDispatchToProps(dispatch) {
  return {
    actions: {
      ...
      showUpdateAlert: bindActionCreators(
        usersActions.showUpdateAlert,
        dispatch,
      ),
